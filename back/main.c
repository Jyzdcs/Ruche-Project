...
void getJSON_DataFromSensors(char *sDataFromSensors)
{
    ...
    // Copy la température de l'eau dans la chaine de caractère JSON de retour
    char lattitude[30] = "18.68380";
    //sensors.requestPosition();
    strcat(sDataFromSensors, "\"Lattitude de la ruche \":\" ");
    strcat(sDataFromSensors, lattitude);
    strcat(sDataFromSensors, "\",");
    
    // Copy la température de l'air dans la chaine de caractère JSON de retour
    char longitude[30] = "13.13988";
    strcat(sDataFromSensors, "\"Longitude de la ruche\":\" ");
    strcat(sDataFromSensors, longitude);
    strcat(sDataFromSensors, "\"");
